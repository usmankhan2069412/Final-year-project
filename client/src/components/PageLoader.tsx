...
export default function PageLoader({ page = "dashboard" }: PageLoaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        {/* ── Main Panel Custom Content Skeleton ── */}
        <main className="flex-1 overflow-y-auto p-4 sm:p-8 lg:p-12 z-10 space-y-8">
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                  <div className="space-y-2">
                    <div className={`h-6 w-48 rounded ${c("bg-black/5", "bg-white/5")}`} />
                    <div className={`h-4 w-64 rounded ${c("bg-black/5", "bg-white/5")}`} />
                  </div>
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center gap-4 py-2">
